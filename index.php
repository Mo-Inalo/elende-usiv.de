...
<div class="row" style="margin-right:auto">
        ...
        <div class="typewriter">
            ...
            <h5 class=" my-5 Elendeauswahl" style="text-align: justify"> I'm EEElende Usiv, a Cologne-based composer and music editor for media who has
    ...
    <div class=" px-5 py-3">
        ...
        <div align="center" class="mx-5 my-5">
            <a href="https://www.youtube.com/watch?v=osVSP4WzVrg" target="_blank" rel="noopener noreferrer">
                <img src="images/ablumcover_winter.jpg" style="
    border-radius: 50%;
    height: 100%;
    width: 50%;
">
